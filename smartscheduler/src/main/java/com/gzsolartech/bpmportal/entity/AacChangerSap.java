...
@Entity
@Table(name = "AAC_CHANGES_SAP")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE, region = "AacChangerSap")
public class AacChangerSap{
	@Id
	...
	public String toString() {
		return "AacChangerSap [pernr=" + pernr + ", ename=" + ename + ", state=" + state + ", massn=" + massn
				+ ", massn_t=" + massnT + ", massnBpm=" + massnBpm + ", massg=" + massg + ", massgT=" + massgT
